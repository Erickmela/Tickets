    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carritos', to='usuarios.perfilcliente')),
            ],
        ),
        migrations.CreateModel(
            name='CarritoItem',
            fields=[
                ...
                ('zona', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='eventos.zona')),
            ],
        ),
        migrations.CreateModel(
            name='Orden',
            fields=[
                ...
                ('mp_status_detail', models.CharField(blank=True, max_length=100, null=True)),
                ('mp_payment_method_id', models.CharField(blank=True, max_length=50, null=True)),
                ('mp_payment_type', models.CharField(blank=True, max_length=50, null=True)),
                ('mp_preference_id', models.CharField(blank=True, max_length=50, null=True)),
                ('mp_merchant_order_id', models.CharField(blank=True, max_length=50, null=True)),
                ('estado', models.CharField(default='pendiente', max_length=20)),
                ('observaciones', models.TextField(blank=True)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ordenes', to='usuarios.perfilcliente')),
            ],
        ),
        migrations.CreateModel(
            name='OrdenItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigo_venta', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Código único de la venta para URLs seguras', unique=True, verbose_name='Código de Venta')),
                ...
                ('orden', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ventas', to='ventas.orden')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dni_titular', models.CharField(blank=True, help_text='DNI de la persona que usará este ticket (se completa al ingresar al evento)', max_length=8, null=True, validators=[django.core.validators.RegexValidator(message='El DNI debe tener 8 dígitos', regex='^\\d{8}$')], verbose_name='DNI del Titular')),
                ('nombre_titular', models.CharField(blank=True, help_text='Nombre de la persona que usará este ticket (se completa al ingresar al evento)', max_length=200, null=True, verbose_name='Nombre del Titular')),
                ...
                ('token_encriptado', models.TextField(blank=True, help_text='Token con UUID encriptado usando AES-256 + HMAC para máxima seguridad', verbose_name='Token Encriptado')),
                ...
                ('presentacion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tickets', to='eventos.presentacion', verbose_name='Presentación')),
